...
const char *ssid =  "28N4F";     // replace with your wifi ssid and wpa2 key
      ...
      if((h-h2)==h){  //如果重量值等於上一個重量值=初值 沒變化值 h3(變化值)=0
        ...
        Serial.println (avg) ;  
          ...
          if (client.connect(server,80)){                    //   "184.106.153.149" or api.thingspeak.com    //連線到THINGSPEAK
                             ...
                             client.print(String("GET ") + resource + apiKey2 +  "&field1=" + absavg1 + "&field2=" +  absavg2 + "&field4=" +  absavg + //傳前七天於頻道1 後七天頻道2 平均差值頻道4
                              " HTTP/1.1\r\n" +
                              "Host: " + server + "\r\n" + 
                              "Connection: close\r\n\r\n");
